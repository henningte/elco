...
#'
#' A `data.frame` with simulated C, H, N, O contents, and sample masses for five samples.
#'
...
#'
#' A `data.frame` with chemical element-specific heuristic correction factors for XRF element contents (relative to
...
#'   \item{correction_factor}{A `quantities` vector with the mean, standard deviation, and
#'   unit for each correction factor. See [elco::elco_xrf_correct_elements()]}

...
1. Import raw data files (csv files) as exported from the IRMS device in the lab (___ todo: add model and company name and version).
...
Isotope signaures can be corrected with a heuristic procedure using `elco::elco_irms_correct_isotopes`
